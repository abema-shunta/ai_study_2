...
# ref http://nonbiri-tereka.hatenablog.com/entry/2015/06/21/220506
...
def forward(x_data, y_data, train=True):
    x, t = Variable(x_data.astype(np.float32), volatile=not train), Variable(y_data.astype(np.int32), volatile=not train)
